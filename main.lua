...
return function(cfg, remaps)
    ...
    local measuring_dst = {
        ...
        w = cfg.measuring_window.w or 70 * cfg.measuring_window.size,
        h = cfg.measuring_window.h or 40 * cfg.measuring_window.size,
    }
    ...
    config.actions = {
        ...
        ["Shift-I"] = function()
            ...
            keybinds_text = waywall.text(
                ...
                (cfg.launch_paceman_key and "Launch paceman = " .. cfg.launch_paceman_key .. "\n" or "") ..
    ...
    if cfg.launch_paceman_key then
